$(document).ready(function() {
    ...
    // div that holds all of our articles
    ...
    function initPage() {
      // Empty the article container, run an AJAX request for any unsaved hadlines
      ...
      $.get("/api/headlines?saved=false")
        .then(function(data) {
          ...
          if (data && data.length) {
            ...
            // Otherwise render a message explaning we have no articles
            renderEmpty();
          }
        });
    }
    ...
    function renderArticles(articles) {
      ...
      // append them ot the articleCards container
    ...
    function handleArticleScrape() {
      ...
      $.get("/api/fetch")
        .then(function(data) {
          ...
          // already in our collection, re render the articls on the page
          // and let the user know how mnay unique articles we were able to save
          initPage();
